...
class ParkingSpotsControllerTest < ActionController::TestCase
  ...
  test "should create parking_spot" do
    assert_difference('ParkingSpot.count') do
      post :create, parking_spot: { name: @parking_spot.name, occupied: @parking_spot.occupied, reservable: @parking_spot.reservable, reserved: @parking_spot.reserved }
    end
  ...
  test "should update parking_spot" do
    patch :update, id: @parking_spot, parking_spot: { name: @parking_spot.name, occupied: @parking_spot.occupied, reservable: @parking_spot.reservable, reserved: @parking_spot.reserved }
    assert_redirected_to parking_spot_path(assigns(:parking_spot))
  end
