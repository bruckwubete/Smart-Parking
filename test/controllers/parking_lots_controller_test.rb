...
class ParkingLotsControllerTest < ActionController::TestCase
  ...
  test "should create parking_lot" do
    assert_difference('ParkingLot.count') do
      post :create, parking_lot: { address: @parking_lot.address, city: @parking_lot.city, country: @parking_lot.country, name: @parking_lot.name, phone_number: @parking_lot.phone_number, postal_code: @parking_lot.postal_code, province: @parking_lot.province }
    end
  ...
  test "should update parking_lot" do
    patch :update, id: @parking_lot, parking_lot: { address: @parking_lot.address, city: @parking_lot.city, country: @parking_lot.country, name: @parking_lot.name, phone_number: @parking_lot.phone_number, postal_code: @parking_lot.postal_code, province: @parking_lot.province }
    assert_redirected_to parking_lot_path(assigns(:parking_lot))
  end
